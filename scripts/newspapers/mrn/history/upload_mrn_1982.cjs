...
async function worker(){while(next<audit.pages.length){const p=audit.pages[next++];if(!/^newspapers\/midwest-racing-news\/1982-\d\d-\d\d\/\d+\.jpg$/.test(p.object_key))throw Error('Invalid key');
