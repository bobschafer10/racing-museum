...
export default async function RaceProgramsPage({ searchParams }: { searchParams?: SearchParams }) {
  ...
  return <main className="ma-page">
    ...
    <section className="ma-section"><div className="ma-footer-links"><Link href="/media/search" className="ma-footer-link">Search Publication OCR<span>Search newspapers, yearbooks & programs →</span></Link><Link href="/media/newspapers" className="ma-footer-link">Racing Newspapers<span>Browse newspaper archive →</span></Link><Link href="/media" className="ma-footer-link">Media Archive<span>Return to media archive →</span></Link></div></section>
  </main>
}