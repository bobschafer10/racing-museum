...
const WISSOTA_100_HERO=`${process.env.NEXT_PUBLIC_SUPABASE_URL||'https://szvkleurojiwqkkztxtr.supabase.co'}/storage/v1/object/public/media/photos/master/unknown-track/unknown-year/unknown-track_unknown-year_wissota-infield_unknown-photographer_photo_001.jpg`
...
export default async function Wissota100Page(){
 ...
 const heroSrc=WISSOTA_100_HERO;const years=Array.from({length:LAST_YEAR-FIRST_YEAR+1},(_,i)=>LAST_YEAR-i)
