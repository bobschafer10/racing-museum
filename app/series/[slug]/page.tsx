      ...
      <section style={contentWrap}>
        <div style={mainGrid}>
          <div style={leftColumn}>
            ...
            {latestSeason && latestStandings && latestStandings.length > 0 && (
              <Panel title={`${latestSeason.year} Final Standings Preview`}>
                ...
                {latestStandings.slice(0, 5).map((row: any) => (
          ...
          <div style={rightColumn}>
            <Panel title="Series Highlights">
              ...
              {topWinner && (
                <SummaryRow
                  label="Most Recorded Wins"
                  value={`${topWinner[0]} — ${topWinner[1]}`}
                />
              )}
...
const heroStat: CSSProperties = {
  background: 'rgba(241, 229, 206, 0.76)',
...
const seasonCard: CSSProperties = {
  display: 'grid',
  gridTemplateColumns: '80px minmax(0, 1fr) auto 24px',
  gap: '12px',
  alignItems: 'center',
  padding: '13px 4px',
...
const decadeGrid: CSSProperties = {
  display: 'grid',
  gridTemplateColumns: 'repeat(auto-fit, minmax(210px, 1fr))',
  gap: '12px',
}

const decadeCard: CSSProperties = {
  background: '#eadfc7',
  border: '1px solid #c2a97d',
  padding: '12px',
}

const decadeTitle: CSSProperties = {
  fontSize: '20px',
  fontWeight: 700,
  color: '#5b3a1b',
  marginBottom: '8px',
...
const yearChipGrid: CSSProperties = {
  display: 'flex',
  flexWrap: 'wrap',
  gap: '7px',
}
...
const seasonSnapshotHeader: CSSProperties = {
  display: 'flex',
...
const snapshotChampionLabel: CSSProperties = {
  fontSize: '13px',
  textTransform: 'uppercase',
  letterSpacing: '.6px',
  color: '#72502c',
...
const snapshotChampion: CSSProperties = {
  fontSize: '27px',
  fontWeight: 700,
  color: '#3d2b16',
}
...
const eventCardGrid: CSSProperties = {
  display: 'grid',
  gridTemplateColumns: 'repeat(auto-fit, minmax(210px, 1fr))',
  gap: '12px',
}
...
const eventRaceNo: CSSProperties = {
  fontSize: '13px',
  textTransform: 'uppercase',
  letterSpacing: '.6px',
  color: '#7a5827',
...
const standingsHeader: CSSProperties = {
  display: 'grid',
  gridTemplateColumns: '55px 1fr 80px 70px',
  gap: '8px',
  fontWeight: 700,
  color: '#5b3a1b',
  padding: '7px 0',
