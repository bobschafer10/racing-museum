...
<div style={heroYearRow}>
  <div style={heroYearCard}>
    <div style={heroYearValue}>{firstRecordedYear ?? '—'}</div>
    <div style={heroYearLabel}>First Recorded Feature Race Results Year</div>
  </div>

  <div style={heroYearCard}>
    <div style={heroYearValue}>{lastRecordedYear ?? '—'}</div>
    <div style={heroYearLabel}>Last Recorded Feature Race Results Year</div>
  </div>
</div>
...
function HeroStat({ label, value }: { label: string; value: number }) {
  return (
    <div style={heroStatCard}>
      <div style={heroStatValue}>{value.toLocaleString()}</div>
