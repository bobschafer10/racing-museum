...
export default async function PhotosPage({ searchParams }: { searchParams: Promise<SearchParams> }) {
  ...
  const selectedDriver=params.driver?formatDriverSlugName(params.driver):null
